...
The composer test intercepted navigation locally: no message was sent. The original PNG logo files have not been modified; WebP and AVIF derivatives are lossless resized copies. Fonts are locally served SIL-licensed Latin WOFF2 subsets.
